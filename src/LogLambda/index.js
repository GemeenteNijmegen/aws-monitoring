...
// index.ts
var LogLambda_exports = {};
__export(LogLambda_exports, {
  createMessage: () => createMessage,
  getEventType: () => getEventType,
  handler: () => handler,
  messageShouldTriggerAlert: () => messageShouldTriggerAlert,
  parseMessageFromEvent: () => parseMessageFromEvent,
  slackParamsFromMessage: () => slackParamsFromMessage
});
module.exports = __toCommonJS(LogLambda_exports);
...
function parseMessageFromEvent(event) {
  var _a, _b;
  return JSON.parse((_b = (_a = event == null ? void 0 : event.Records[0]) == null ? void 0 : _a.Sns) == null ? void 0 : _b.Message);
}
function getEventType(message) {
  return message == null ? void 0 : message["detail-type"];
}
function messageShouldTriggerAlert(message) {
...
function cloudwatchAlarmEventShouldTriggerAlert(message) {
  var _a, _b, _c, _d;
  const state = (_b = (_a = message == null ? void 0 : message.detail) == null ? void 0 : _a.state) == null ? void 0 : _b.value;
  const previousState = (_d = (_c = message == null ? void 0 : message.detail) == null ? void 0 : _c.previousState) == null ? void 0 : _d.value;
  if (state == "ALARM" || previousState == "ALARM") {
    return true;
  }
  return false;
}
function slackParamsFromMessage(message) {
  const eventType = getEventType(message);
  if (eventType == "CloudWatch Alarm State Change") {
...
function slackParamsFromAlarmMessage(message) {
  var _a, _b, _c, _d, _e, _f;
  let messageObject = {
    title: "",
    message: message == null ? void 0 : message.detail.state.reason,
  ...
  if (((_b = (_a = message == null ? void 0 : message.detail) == null ? void 0 : _a.state) == null ? void 0 : _b.value) == "ALARM") {
    messageObject.title = `\u2757\uFE0F Alarm: ${message.detail.alarmName}`;
  } else if (((_d = (_c = message == null ? void 0 : message.detail) == null ? void 0 : _c.state) == null ? void 0 : _d.value) == "OK") {
    messageObject.title = `\u2705 Alarm ended: ${message.detail.alarmName}`;
  } else if (((_f = (_e = message == null ? void 0 : message.detail) == null ? void 0 : _e.state) == null ? void 0 : _f.value) == "INSUFFICIENT_DATA") {
    messageObject.title = `Insufficient data: ${message.detail.alarmName}`;
  }
  return messageObject;
}
function createMessage(messageObject) {
  const templateBuffer = import_fs.default.readFileSync(import_path.default.join(__dirname, "template.json"));
...
async function sendMessageToSlack(message) {
  ...
  return import_axios.default.post(process.env.SLACK_WEBHOOK_URL, message);
}
...
0 && (module.exports = {
  ...
  getEventType,
  handler,
  messageShouldTriggerAlert,
  parseMessageFromEvent,
  slackParamsFromMessage
});
/*!
 * mime-db
